...
本批 review 发现的问题若需在后续批解决 → 标 `DEFERRED-TO-BATCH-[id]` 进 follow-up，不在本批扩范围。

## Commit Discipline

- Stage 2/3 期间**不 commit**；Stage 4 收口后用户做真实 commit
- 每批一个 commit（accumulated diff = stage 2 + stage 4 fix）
