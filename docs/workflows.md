...
- **基线约束**：[AGENTS.md](../AGENTS.md) · [docs/agents-governance.md](agents-governance.md)
- **校验入口**：`./tasks.sh sync-skills`（修 skill 后必跑）· `./tasks.sh validate`（收口；含 `sync:skills --check` / `lint:agents` / `check:refs`）
